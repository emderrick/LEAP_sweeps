...
mag_contigs <- read_tsv("data files/T1_refined.stb", col_names = c("contig", "mag"))
...
write_tsv(args, "data files/samtools_mag_args.tsv", col_names = F) 
...
write_tsv(sub_args, "data files/samtools_subsample_args.tsv", col_names = F) 
