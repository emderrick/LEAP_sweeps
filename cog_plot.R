...
cog_results <- read_csv("refined data files/refined_syn_COG_enrichment_T1_MAG_SNVs.csv")
...
ggsave("refined figures/refined_syn_COG_summary_plot.pdf", COG_summary_plot, height = 6, width = 14)
