...
NS_SNV_log10_plot <- ggplot(MAG_NS_plotting, aes(x = NS_ratio, y = log10(SNVs_MBp), colour = diversity))+
  geom_point(aes(shape=sweep), size=2.5)+
  scale_color_manual(values = c("#481467", "#238a8d" ))+
...
save_plot("NS_SNV_log10_plot.jpeg", NS_SNV_log10_plot)
