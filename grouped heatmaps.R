...
all_snv <- read_csv("all_MAG_SNVs_med_Aug8.csv")
...
select_mag_labs<-(c(I4_MAG_00006 = "SJAQ100 sp016735685 assembled from Control B", I4_MAG_00065 = "Roseomonas sp. assembled from Control B", 
