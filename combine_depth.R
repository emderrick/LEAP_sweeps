...
I4_MAG_00006_depth <- read.table("mag depth/I4_MAG_00006_depth.txt", sep="\t", header=F)
...
all_I4_MAG_00006 = all_I4_MAG_00006[,c(1:13, 85, 14:84)]
...
I4_MAG_00065_depth <- read.table("mag depth/I4_MAG_00065_depth.txt", sep="\t", header=F)
...
all_I4_MAG_00065 = all_I4_MAG_00065[,c(1:13, 85, 14:84)]
write.csv(all_I4_MAG_00065, "all_I4_MAG_00065_SNVs.csv", row.names=F)


L2_MAG_00048 <- filter(filtered_SNVs, mag=="L2_MAG_00048")
L2_MAG_00048$groups<- paste(L2_MAG_00048$scaffold, str_pad(L2_MAG_00048$position, 7, pad = "0"))
L2_MAG_00048 <- complete(L2_MAG_00048, timepoint, groups)

L2_MAG_00048_depth <- read.table("mag depth/L2_MAG_00048_depth.txt", sep="\t", header=F)
L2_MAG_00048_depth <- L2_MAG_00048_depth %>% rename("scaffold"="V1", "position"="V2", "samtools_depth"="V3", "timepoint"="V4")
L2_MAG_00048_depth$groups<- paste(L2_MAG_00048_depth$scaffold, str_pad(L2_MAG_00048_depth$position, 7, pad = "0"))
L2_MAG_00048_depth <- mutate(L2_MAG_00048_depth, new_ref_freq = ifelse(samtools_depth >= 5, 1, NA))

all_L2_MAG_00048 <- right_join(L2_MAG_00048_depth, L2_MAG_00048, by=c("timepoint", "groups"))
all_L2_MAG_00048 <- mutate(all_L2_MAG_00048, final_ref_freq= ifelse(is.na(ref_freq), new_ref_freq, ref_freq))
all_L2_MAG_00048 = all_L2_MAG_00048[,c(1:13, 85, 14:84)]
write.csv(all_L2_MAG_00048, "all_L2_MAG_00048_SNVs.csv", row.names=F)
...
L2_MAG_00052_depth <- read.table("mag depth/L2_MAG_00052_depth.txt", sep="\t", header=F)
...
all_L2_MAG_00052 = all_L2_MAG_00052[,c(1:13, 85, 14:84)]
...
L3_MAG_00058_depth <- read.table("mag depth/L3_MAG_00058_depth.txt", sep="\t", header=F)
...
all_L3_MAG_00058 = all_L3_MAG_00058[,c(1:13, 85, 14:84)]
...
L4_MAG_00099_depth <- read.table("mag depth/L4_MAG_00099_depth.txt", sep="\t", header=F)
...
all_L4_MAG_00099 = all_L4_MAG_00099[,c(1:13, 85, 14:84)]
...
L7_MAG_00020_depth <- read.table("mag depth/L7_MAG_00020_depth.txt", sep="\t", header=F)
...
all_L7_MAG_00020 = all_L7_MAG_00020[,c(1:13, 85, 14:84)]
...
L7_MAG_00028_depth <- read.table("mag depth/L7_MAG_00028_depth.txt", sep="\t", header=F)
...
all_L7_MAG_00028 = all_L7_MAG_00028[,c(1:13, 85, 14:84)]
...
L7_MAG_00043_depth <- read.table("mag depth/L7_MAG_00043_depth.txt", sep="\t", header=F)
...
all_L7_MAG_00043 = all_L7_MAG_00043[,c(1:13, 85, 14:84)]
...
L8_MAG_00011_depth <- read.table("mag depth/L8_MAG_00011_depth.txt", sep="\t", header=F)
...
all_L8_MAG_00011 = all_L8_MAG_00011[,c(1:13, 85, 14:84)]
...
L8_MAG_00019_depth <- read.table("mag depth/L8_MAG_00019_depth.txt", sep="\t", header=F)
...
all_L8_MAG_00019 = all_L8_MAG_00019[,c(1:13, 85, 14:84)]
...
L8_MAG_00042_depth <- read.table("mag depth/L8_MAG_00042_depth.txt", sep="\t", header=F)
...
all_L8_MAG_00042 = all_L8_MAG_00042[,c(1:13, 85, 14:84)]
