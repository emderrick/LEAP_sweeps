...
L3_MAG_00058_50_1 <- (list(L3_MAG_00058_L3_1,L3_MAG_00058_L4_1,L3_MAG_00058_L7_1,L3_MAG_00058_L8_1)  
                      %>% reduce(inner_join, by='groups') %>% select(starts_with(c('groups', 'pond', 'final_ref_freq', 'mag.x','gene.x'))))
...
L3_MAG_00058_50_2 <- (list(L3_MAG_00058_L3_2,L3_MAG_00058_L4_2,L3_MAG_00058_L7_2,L3_MAG_00058_L8_2)  
                      %>% reduce(inner_join, by='groups') %>% select(starts_with(c('groups', 'pond', 'final_ref_freq'))))
...
L4_MAG_00099_50_1 <- (list(L4_MAG_00099_L4_1,L4_MAG_00099_L2_1,L4_MAG_00099_L6_1,L4_MAG_00099_L7_1,L4_MAG_00099_L8_1)  
                      %>% reduce(inner_join, by='groups') %>% select(starts_with(c('groups', 'pond', 'final_ref_freq'))))
...
L4_MAG_00099_50_2 <- (list(L4_MAG_00099_L4_2,L4_MAG_00099_L2_2,L4_MAG_00099_L6_2,L4_MAG_00099_L7_2,L4_MAG_00099_L8_2)  
                      %>% reduce(inner_join, by='groups') %>% select(starts_with(c('groups', 'pond', 'final_ref_freq'))))
...
L8_MAG_00019_50_1 <- (list(L8_MAG_00019_I8_1,L8_MAG_00019_L2_1,L8_MAG_00019_L6_1,L8_MAG_00019_L8_1)  
                      %>% reduce(inner_join, by='groups') %>% select(starts_with(c('groups', 'pond', 'final_ref_freq'))))
...
L8_MAG_00019_50_2 <- (list(L8_MAG_00019_I8_2,L8_MAG_00019_L2_2,L8_MAG_00019_L6_2,L8_MAG_00019_L8_2)  
                      %>% reduce(inner_join, by='groups') %>% select(starts_with(c('groups', 'pond', 'final_ref_freq'))))
...
L8_MAG_00011_50_1 <- (list(L8_MAG_00011_I8_1,L8_MAG_00011_L2_1,L8_MAG_00011_L8_1)  
                      %>% reduce(inner_join, by='groups') %>% select(starts_with(c('groups', 'pond', 'final_ref_freq'))))
...
L8_MAG_00011_50_2 <- (list(L8_MAG_00011_I8_2,L8_MAG_00011_L2_2,L8_MAG_00011_L8_2)  
                      %>% reduce(inner_join, by='groups') %>% select(starts_with(c('groups', 'pond', 'final_ref_freq'))))
...
L7_MAG_00043_50_1 <- (list(L7_MAG_00043_L4_1,L7_MAG_00043_L6_1,L7_MAG_00043_L7_1)  
                      %>% reduce(inner_join, by='groups') %>% select(starts_with(c('groups', 'pond', 'final_ref_freq'))))
...
L7_MAG_00043_50_2 <- (list(L7_MAG_00043_L4_2,L7_MAG_00043_L6_2,L7_MAG_00043_L7_2)  
                      %>% reduce(inner_join, by='groups') %>% select(starts_with(c('groups', 'pond', 'final_ref_freq'))))
...
L7_MAG_00028_50_1 <- (list(L7_MAG_00028_I8_1,L7_MAG_00028_L2_1,L7_MAG_00028_L6_1,L7_MAG_00028_L7_1)  
                      %>% reduce(inner_join, by='groups') %>% select(starts_with(c('groups', 'pond', 'final_ref_freq'))))
...
L7_MAG_00028_50_2 <- (list(L7_MAG_00028_I8_2,L7_MAG_00028_L2_2,L7_MAG_00028_L6_2,L7_MAG_00028_L7_2)  
                      %>% reduce(inner_join, by='groups') %>% select(starts_with(c('groups', 'pond', 'final_ref_freq'))))
...
I4_MAG_00006_50_1 <- (list(I4_MAG_00006_I4_1, I4_MAG_00006_I8_1, I4_MAG_00006_L2_1, I4_MAG_00006_L8_1)  
                      %>% reduce(inner_join, by='groups') %>% select(starts_with(c('groups', 'pond', 'final_ref_freq'))))
...
I4_MAG_00006_50_2 <- (list(I4_MAG_00006_I4_2, I4_MAG_00006_I8_2, I4_MAG_00006_L2_2, I4_MAG_00006_L8_2)  
                      %>% reduce(inner_join, by='groups') %>% select(starts_with(c('groups', 'pond', 'final_ref_freq'))))
...
I4_MAG_00065_50_1 <- (list(I4_MAG_00065_I4_1, I4_MAG_00065_I8_1, I4_MAG_00065_K1_1, I4_MAG_00065_L3_1, I4_MAG_00065_L4_1, I4_MAG_00065_L6_1)  
                      %>% reduce(inner_join, by='groups') %>% select(starts_with(c('groups', 'pond', 'final_ref_freq'))))
...
I4_MAG_00065_50_2 <- (list(I4_MAG_00065_I4_2, I4_MAG_00065_I8_2, I4_MAG_00065_K1_2, I4_MAG_00065_L3_2, I4_MAG_00065_L4_2, I4_MAG_00065_L6_2) 
                      %>% reduce(inner_join, by='groups') %>% select(starts_with(c('groups', 'pond', 'final_ref_freq'))))
...
L7_MAG_00020_50_1 <- (list(L7_MAG_00020_K1_1,L7_MAG_00020_L3_1,L7_MAG_00020_L4_1,L7_MAG_00020_L2_1)  
                      %>% reduce(inner_join, by='groups') %>% select(starts_with(c('groups', 'pond', 'final_ref_freq'))))
...
L7_MAG_00020_50_2 <- (list(L7_MAG_00020_K1_2,L7_MAG_00020_L3_2,L7_MAG_00020_L4_2,L7_MAG_00020_L2_2) 
                      %>% reduce(inner_join, by='groups') %>% select(starts_with(c('groups', 'pond', 'final_ref_freq'))))
...
L8_MAG_00042_50_1 <- (list(L8_MAG_00042_I8_1,L8_MAG_00042_K1_1,L8_MAG_00042_L3_1,L8_MAG_00042_L4_1,L8_MAG_00042_L8_1)  
                      %>% reduce(inner_join, by='groups') %>% select(starts_with(c('groups', 'pond', 'final_ref_freq'))))
...
L8_MAG_00042_50_2 <- (list(L8_MAG_00042_I8_2,L8_MAG_00042_K1_2,L8_MAG_00042_L3_2,L8_MAG_00042_L4_2,L8_MAG_00042_L8_2)  
                      %>% reduce(inner_join, by='groups') %>% select(starts_with(c('groups', 'pond', 'final_ref_freq'))))
...
L2_MAG_00052_50_1 <- (list(L2_MAG_00052_I4_1,L2_MAG_00052_I8_1,L2_MAG_00052_K1_1,L2_MAG_00052_L4_1,L2_MAG_00052_L2_1)  
                      %>% reduce(inner_join, by='groups') %>% select(starts_with(c('groups', 'pond', 'final_ref_freq'))))
...
L2_MAG_00052_50_2 <- (list(L2_MAG_00052_I4_2,L2_MAG_00052_I8_2,L2_MAG_00052_K1_2,L2_MAG_00052_L4_2,L2_MAG_00052_L2_2)  
                      %>% reduce(inner_join, by='groups') %>% select(starts_with(c('groups', 'pond', 'final_ref_freq'))))
