...
class_1 <- c("sig_genes_loose_C1_subsamp.csv", "sig_genes_strict_C1_subsamp.csv", "sig_genes_par_snv_decrease_C1_subsamp.csv", "sig_genes_snv_decrease_C1_subsamp.csv", "sig_genes_threshold_C1_subsamp.csv", "sig_genes_increase_C1_subsamp.csv", "sig_genes_decrease_C1_subsamp.csv")
...
class_2 <- c("sig_genes_loose_C2_subsamp.csv", "sig_genes_strict_C2_subsamp.csv", "sig_genes_par_snv_decrease_C2_subsamp.csv", "sig_genes_snv_decrease_C2_subsamp.csv", "sig_genes_threshold_C2_subsamp.csv", "sig_genes_increase_C2_subsamp.csv", "sig_genes_decrease_C2_subsamp.csv")
...
# NS_gene_files <- c("significant_genes_strict_inc_NS.csv", "significant_genes_strict_dec_NS.csv", "significant_genes_loose_inc_NS.csv", "significant_genes_loose_dec_NS.csv")
# 
# for(gene_file in NS_gene_files){
#   significant_genes_df <- read_csv(gene_file)
#   significant_genes <- significant_genes_df[, c("COG_ID")] %>% na.omit()
#   significant_genes <- significant_genes[['COG_ID']]
#   background_genes_df <- all_background_genes %>% subset(!(gene %in% significant_genes_df$gene))
